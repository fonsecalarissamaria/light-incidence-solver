...
// (Mais estável que produto vetorial para coordenadas grandes)
static bool checkLineIntersection(const Segment& ray, const Segment& wall) {
    ...
    // Verifica se a interseção acontece dentro dos segmentos [0, 1]
    // Usa Epsilon para garantir que pontas e quinas sejam detectadas
